...
\begin{thebibliography}{100}
        \bibitem{Alexander Bogomolny} Alexander Bogomolny. ``Cut-The-Knot''. Published. 2020.
        \bibitem{Wikipedia} Wikipedia. "Irrationality of pi". Last Modified 21 June 2025
        \bibitem{Chili Math} Chili Math. Prove: Suppose n is an integer. If $n^2$ is even, then $n$ is even. 
        \bibitem{Nasa} Nasa. The Transcendentality of $\pi$
    \end{thebibliography}
\end{document}
